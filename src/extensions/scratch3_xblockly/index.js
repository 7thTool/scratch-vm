 ...
 * https://github.com/LLK/scratch-xblockly-firmware/blob/master/protocol.md
 * @readonly
 * @enum {number}
 */
const BLECommand = {
...
class XBlockly {
    ...
    send (command, message) {
        console.log('cmd=', command, ' msg=', message);
...
class Scratch3XBlocklyBlocks {
    ...
    get BUTTONS_MENU () {
        return [
            {
                text: 'A',
                value: XBlocklyButtons.A
            },
            {
                text: 'B',
                value: XBlocklyButtons.B
            },
            {
                text: formatMessage({
                    id: 'xblockly.buttonsMenu.any',
                    default: 'any',
                    description: 'label for "any" element in button picker for micro:bit extension'
                }),
                value: XBlocklyButtons.ANY
            }
        ];
    }
    ...
    get GESTURES_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'xblockly.gesturesMenu.moved',
                    default: 'moved',
                    description: 'label for moved gesture in gesture picker for micro:bit extension'
                }),
                value: XBlocklyGestures.MOVED
            },
            {
                text: formatMessage({
                    id: 'xblockly.gesturesMenu.shaken',
                    default: 'shaken',
                    description: 'label for shaken gesture in gesture picker for micro:bit extension'
                }),
                value: XBlocklyGestures.SHAKEN
            },
            {
                text: formatMessage({
                    id: 'xblockly.gesturesMenu.jumped',
                    default: 'jumped',
                    description: 'label for jumped gesture in gesture picker for micro:bit extension'
                }),
                value: XBlocklyGestures.JUMPED
            }
        ];
    }
    ...
    get PIN_STATE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'xblockly.pinStateMenu.on',
                    default: 'on',
                    description: 'label for on element in pin state picker for micro:bit extension'
                }),
                value: XBlocklyPinState.ON
            },
            {
                text: formatMessage({
                    id: 'xblockly.pinStateMenu.off',
                    default: 'off',
                    description: 'label for off element in pin state picker for micro:bit extension'
                }),
                value: XBlocklyPinState.OFF
            }
        ];
    }
    ...
    get TILT_DIRECTION_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'xblockly.tiltDirectionMenu.front',
                    default: 'front',
                    description: 'label for front element in tilt direction picker for micro:bit extension'
                }),
                value: XBlocklyTiltDirection.FRONT
            },
            {
                text: formatMessage({
                    id: 'xblockly.tiltDirectionMenu.back',
                    default: 'back',
                    description: 'label for back element in tilt direction picker for micro:bit extension'
                }),
                value: XBlocklyTiltDirection.BACK
            },
            {
                text: formatMessage({
                    id: 'xblockly.tiltDirectionMenu.left',
                    default: 'left',
                    description: 'label for left element in tilt direction picker for micro:bit extension'
                }),
                value: XBlocklyTiltDirection.LEFT
            },
            {
                text: formatMessage({
                    id: 'xblockly.tiltDirectionMenu.right',
                    default: 'right',
                    description: 'label for right element in tilt direction picker for micro:bit extension'
                }),
                value: XBlocklyTiltDirection.RIGHT
            }
        ];
    }
    ...
    get TILT_DIRECTION_ANY_MENU () {
        return [
            ...
            {
                text: formatMessage({
                    id: 'xblockly.tiltDirectionMenu.any',
                    default: 'any',
                    description: 'label for any direction element in tilt direction picker for micro:bit extension'
                }),
                value: XBlocklyTiltDirection.ANY
            }
        ];
    }
            ...
            blocks: [
                {
                    ...
                    arguments: {
                        BTN: {
                            ...
                            menu: 'buttons',
                            defaultValue: XBlocklyButtons.A
                        }
                    }
                },
                {
                ...
                '---',
                {
                    ...
                    arguments: {
                        GESTURE: {
                            type: ArgumentType.STRING,
                            menu: 'gestures',
                            defaultValue: XBlocklyGestures.MOVED
                        }
                    }
                },
                '---',
                    ...
                    arguments: {
                        TEXT: {
                            ...
                            defaultValue: formatMessage({
                                id: 'xblockly.defaultTextToDisplay',
                                default: 'Hello!',
                ...
                '---',
                {
                    ...
                    arguments: {
                        DIRECTION: {
                            ...
                            defaultValue: XBlocklyTiltDirection.ANY
                        }
                    }
                },
                {
                ...
                },
                {
                    ...
                    arguments: {
                        DIRECTION: {
                            type: ArgumentType.STRING,
                            menu: 'tiltDirection',
                            defaultValue: XBlocklyTiltDirection.FRONT
                        }
                    }
                },
                '---',
    ...
    _isTilted (direction) {
        switch (direction) {
        case XBlocklyTiltDirection.ANY:
            return (Math.abs(this._peripheral.tiltX / 10) >= Scratch3XBlocklyBlocks.TILT_THRESHOLD) ||
                (Math.abs(this._peripheral.tiltY / 10) >= Scratch3XBlocklyBlocks.TILT_THRESHOLD);
        default:
            return this._getTiltAngle(direction) >= Scratch3XBlocklyBlocks.TILT_THRESHOLD;
        }
    }
    ...
    _getTiltAngle (direction) {
        switch (direction) {
        case XBlocklyTiltDirection.FRONT:
            return Math.round(this._peripheral.tiltY / -10);
        case XBlocklyTiltDirection.BACK:
            return Math.round(this._peripheral.tiltY / 10);
        case XBlocklyTiltDirection.LEFT:
            return Math.round(this._peripheral.tiltX / -10);
        case XBlocklyTiltDirection.RIGHT:
            return Math.round(this._peripheral.tiltX / 10);
        default:
